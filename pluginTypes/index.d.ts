...
declare module "@ijstech/ln-wallet/webln-inf.ts" {
    ...
    type WebLNRequestListInvoicesRequestFunc = (method: "request.listinvoices", args?: {
        reversed?: boolean;
    ...
    type WebLNRequestListPaymentsFunc = (method: "request.listpayments", args?: {
        reversed?: boolean;
        num_max_invoices?: number;
        index_offset?: number;
        pending_only?: boolean;
    ...
    export { WebLNProvider, WebLNMethod, WebLNNode, GetInfoResponse, SendPaymentResponse, RequestInvoiceArgs, KeysendArgs, MakeInvoiceResponse, SignMessageResponse, GetBalanceResponse, LookupInvoiceArgs, LookupInvoiceResponse, WebLNRequestMethod, WebLNRequestWalletBalanceRequestFunc, WebLNRequestListChannelsRequestFunc, WebLNRequestListInvoicesRequestFunc, WebLNRequestListPaymentsFunc, WebLNRequestListPeersRequestFunc, };
}
/// <amd-module name="@ijstech/ln-wallet/webln.ts" />
declare module "@ijstech/ln-wallet/webln.ts" {
    import * as INF from "@ijstech/ln-wallet/webln-inf.ts";
    export class WebLN {
...
declare module "@ijstech/ln-wallet" {
    export * from "@ijstech/ln-wallet/webln.ts";
}
